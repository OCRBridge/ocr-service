...
def mock_engine_registry():
    ...
    Returns EngineRegistry instance with mock Tesseract and EasyOCR engines.
    """
    from tests.mocks.mock_engines import MockEasyOCREngine, MockTesseractEngine
...
@pytest.fixture
def mock_easyocr_engine():
    """Individual mock EasyOCR engine instance."""
    from tests.mocks.mock_engines import MockEasyOCREngine

    return MockEasyOCREngine()
